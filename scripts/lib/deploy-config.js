...
function buildContainerEnv(cfg) {
  return [
    ...
    'CONTAINER_LOGGING=false', 'LOG_LEVEL=warn', 'HUB_FAST_IP_PEEK_MS=0', 'HUB_RELOAD_DEBOUNCE_MS=2500',
    'HUB_NSCACHE=8192', 'HEALTH_CHECK_INTERVAL_MS=120000', 'HEALTH_CHECK_TIMEOUT_MS=10000',
    'AUTO_PROXY_POLL_MS=45000', 'MIKROTIK_REST_CACHE_MS=8000', 'ENABLE_REALTIME=true',
  ].join(',');
}
